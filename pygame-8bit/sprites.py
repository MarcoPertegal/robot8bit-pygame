...
class Diamond(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
        self.groups = self.game.all_skins, self.game.diamond
        pygame.sprite.Sprite.__init__(self, self.groups)
        ...
        self.image = self.game.diamondsheet.sheet
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = self.x, self.y
        self.image.set_colorkey('black')
...
class Bomb(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
        self.groups = self.game.all_skins, self.game.bomb
        pygame.sprite.Sprite.__init__(self, self.groups)
        ...
        self.image = self.game.bombsheet.sheet
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = self.x, self.y
        self.image.set_colorkey('black')
...
class ReinforcedWall(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
        self.groups = self.game.all_skins, self.game.reinforced_walls
        pygame.sprite.Sprite.__init__(self, self.groups)
        ...
        self.image = self.game.reinforced_wallsheet.sheet
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = self.x, self.y
        self.image.set_colorkey('black')